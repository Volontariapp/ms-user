...
export class UserTransformer {
  ...
  fromUserDTO(userDTO: Partial<UserDTO>): UserEntity {
    ...
    if (userDTO.pseudo !== undefined && userDTO.pseudo !== '')
      userEntity.pseudo = userDTO.pseudo;
    ...
    if (userDTO.organisationInfo?.rna !== undefined)
      userEntity.rna = userDTO.organisationInfo.rna;
    if (userDTO.badges !== undefined)
      userEntity.badges = userDTO.badges.map((badge) =>
        this.badgeTransformer.fromBadgeDTO(badge),
      );
  ...
  fromSignUpCommandDTO(dto: SignUpCommandDTO): UserEntity {
    ...
    if (dto.pseudo !== undefined && dto.pseudo !== '')
      userEntity.pseudo = dto.pseudo;
    ...
    if (dto.organisationInfo !== undefined)
      userEntity.rna = dto.organisationInfo.rna;
  ...
  toUserDTO(userEntity: UserEntity): UserDTO {
    ...
    if (userEntity.logoPath !== undefined)
      userDTO.logoPath = userEntity.logoPath;
    userDTO.totalImpactScore = userEntity.totalImpactScore;
    if (userEntity.rna !== undefined)
      userDTO.organisationInfo = { rna: userEntity.rna };
    userDTO.badges = userEntity.badges.map((badge) =>
