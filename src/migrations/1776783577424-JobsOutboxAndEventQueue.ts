...
export class JobsOutboxAndEventQueue1776783577424 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" RENAME COLUMN "logo_path" TO "logoPath"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "badges" ALTER COLUMN "icon_path" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "badges" ALTER COLUMN "icon_path" SET NOT NULL`,
    );
    await queryRunner.query(`DROP TABLE "jobs_outbox"`);
    await queryRunner.query(`DROP TABLE "event_queue"`);
    await queryRunner.query(
      `ALTER TABLE "users" RENAME COLUMN "logoPath" TO "logo_path"`,
    );
    await queryRunner.query(
